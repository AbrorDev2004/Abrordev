                            ...
                            <div class="body">
                                <form action="{{ route('admin.resume.update', $resume->id) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="section nomini yozing" name="section" value="{{ $resume->section }}" required>
                                    </div>
                                    <div class="form-group">
                                        <h2 class="card-inside-title">Title</h2>
                                        <input type="text" class="form-control" placeholder="sarlavhani yozing" name="title" value="{{ $resume->title }}" required>
                                    </div>
                                    <div class="form-group">
                                        <h2 class="card-inside-title">Start date</h2>
                                        <input type="date" class="form-control" placeholder="boshlanish sanasini belgilang" name="start_date" value="{{ $resume->start_date }}" required>
                                    </div>
                                    <div class="form-group">
                                        <h2 class="card-inside-title">End date</h2>
                                        <input type="date" class="form-control" placeholder="tugash sanasini belgilang" name="end_date" value="{{ $resume->end_date }}">
                                    </div>
                                    <div class="form-group">
                                        <h2 class="card-inside-title">Institution</h2>
                                        <input type="text" class="form-control" placeholder="o'qigan yoki tajriba ortirgan ish joyi nomini yozing" name="institution" value="{{ $resume->institution }}" required>
                                    </div>
                                    <div class="form-group">
                                        <textarea name="description" id="summernote" class="summernote">{{ $resume->description }}</textarea>
                                    </div>
                                    <div class="form-group">
