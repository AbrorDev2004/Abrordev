                            ...
                            <div class="body">
                                <form action="{{ route('admin.testimonial.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="lavozimingizni yozing" name="position" required>
                                    </div>
                                    <div class="form-group">
                                        <h2 class="card-inside-title">Company</h2>
                                        <input type="text" class="form-control" placeholder="kompaniya nomini yozing" name="company" required>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <textarea rows="4" class="form-control no-resize" placeholder="Fikr yozing" name="testimonial" required></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
