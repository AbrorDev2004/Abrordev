                            ...
                            <li>
                                <div class="progress-container">
                                    ...
                                    <ul class="list-unstyled team-info">
                                        <li class="m-r-15"><small>Team</small></li>
                                        <li>
                                            <img src="{{ asset('admin/assets/images/xs/avatar10.jpg') }}" alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="{{ asset('admin/assets/images/xs/avatar9.jpg') }}" alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="{{ asset('admin/assets/images/xs/avatar8.jpg') }}" alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="{{ asset('admin/assets/images/xs/avatar7.jpg') }}" alt="Avatar">
                                        </li>
                                        <li>
                            ...
                            <li>
                                <div class="progress-container progress-warning">
                                    ...
                                    <ul class="list-unstyled team-info">
                                        <li class="m-r-15"><small>Team</small></li>
                                        <li>
                                            <img src="{{ asset('admin/assets/images/xs/avatar5.jpg') }}" alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="{{ asset('admin/assets/images/xs/avatar2.jpg') }}" alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="{{ asset('admin/assets/images/xs/avata72.jpg') }}" alt="Avatar">
                                        </li>
                                    </ul>
                                </div>
                            </li>
