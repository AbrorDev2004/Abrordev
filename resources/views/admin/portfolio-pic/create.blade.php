                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="card">
                            ...
                            <div class="body">
                                <form action="{{ route('admin.portfolio-pic.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('POST')
                                    <div class="form-group">
                                        <h2 class="card-inside-title">Image</h2>
                                        <input multiple type="file" class="dropify" data-allowed-file-extensions="png jpg jpeg" name="image[]" required>
                                    </div>
                                    <div class="form-group">
