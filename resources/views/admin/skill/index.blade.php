            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-7 col-md-6 col-sm-12">
                        <h2>skills (mutaxasislik)</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item active"><i class="zmdi zmdi-home"></i> skills/</li>
                        </ul>
                                        ...
                                        <tbody>
                                            @foreach ($skills as $skill)
                                                <tr>
                                                    ...
                                                    <td>{{ $skill->level }}</td>
                                                    <td>
                                                        <a href="{{ route('admin.skill.edit', $skill->id) }}" class="btn btn-primary btn-sm"><i class="zmdi zmdi-edit"></i> Edit</a>
                                                        <form action="{{ route('admin.skill.destroy', $skill->id) }}" method="POST" class="d-inline">
                                                            @csrf
                                                            @method('DELETE')
