                            ...
                            <div class="body">
                                <form action="{{ route('admin.skill.update', $skill->id) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="nomini yozing" name="name" value="{{ $skill->name }}" required>
                                    </div>
                                    <div class="form-group">
                                        <h2 class="card-inside-title">Level</h2>
                                        <input type="number" class="form-control" placeholder="Daraja yozing" name="level" min="0" max="100" value="{{ $skill->level }}" required>
                                    </div>
                                    <div class="form-group">
