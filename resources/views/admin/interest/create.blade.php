                            ...
                            <div class="body">
                                <form action="{{ route('admin.interest.store') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="name yozing" name="name" required>
                                    </div>
                                    <div class="form-group">
                                        <h2 class="card-inside-title">Icon</h2>
                                        {{-- icon tanlash uchun link --}}
                                        ikonkalarni kodlarini ushbu <a href="https://remixicon.com/" target="_blank">link </a>oraqali topishingiz mumkin
                                        <input type="text" class="form-control" placeholder="icon nomi yozing, misol: ri-code-line" name="icon" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Rangni kiriting</label>
                                        <div class="input-group colorpicker colorpicker-element">
                                            <input type="text" class="form-control" value="#00AABB" name="color" required>
