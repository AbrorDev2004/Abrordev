            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-7 col-md-6 col-sm-12">
                        <h2>Services (xizmatlar)</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item active"><i class="zmdi zmdi-home"></i> Services/</li>
                        </ul>
                                        ...
                                        <tbody> 
                                            @foreach ($services as $service)
                                                <tr>
                                                    <td>{{ $service->id }}</td>
                                                    <td>{{ $service->title }}</td>
                                                    <td><i class="{{ $service->icon }}" style="font-size: 18px"></i> {{ $service->icon }}</td>
                                                    <td>{{ $service->description }}</td>
                                                    <td>
                                                        <a href="{{ route('admin.service.edit', $service->id) }}" class="btn btn-primary btn-sm"><i class="zmdi zmdi-edit"></i> Edit</a>
