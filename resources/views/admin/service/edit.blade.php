                            ...
                            <div class="body">
                                <form action="{{ route('admin.service.update', $service->id) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="icon nomini yozing" name="icon" value="{{ $service->icon }}" required>
                                    </div>
                                    <div class="form-group">
                                        <h2 class="card-inside-title">Title</h2>
                                        <input type="text" class="form-control" placeholder="sarlavhani yozing" name="title" value="{{ $service->title }}" required>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <textarea rows="4" class="form-control no-resize" placeholder="tavsif yozing" name="description" required>{{ $service->description }}</textarea>
                                                    </div>
                                                </div>  
                                            </div>
                                        </div>
