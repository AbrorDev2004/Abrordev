            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-7 col-md-6 col-sm-12">
                        <h2>Header (Bosh sahifa malumotlari)</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item active"><i class="zmdi zmdi-home"></i> Home/</li>
                        </ul>
                        ...
                        <div class="card">
                            <div class="header">
                                ...
                                <ul class="header-dropdown">
                                    <li>
                                        <a href="{{ route('admin.header.create') }}" class="btn btn-primary">Create</a>
                                    </li>
                                    <li class="remove">
                                    ...
                                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable table-custom">
                                        ...
                                        <tbody>
                                            @foreach ($headers as $header)
                                                <tr>
                                                    <td rowspan="3">
                                                        <img src="{{ asset('assets/img/' . $header->image) }}" alt="" width="100%">
                                                    </td>
                                                    <td>ID</td>
                                                    <td>{{ $header->id }}</td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td>Action</td>
                                                    <td>
                                                        <a href="{{ route('admin.header.edit', $header->id) }}" class="btn btn-primary btn-sm"><i class="zmdi zmdi-edit"></i> Edit</a>
                                                        <form action="{{ route('admin.header.destroy', $header->id) }}" method="POST" class="d-inline">
                                                            @csrf
                                                            @method('DELETE')
