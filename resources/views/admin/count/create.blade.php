                            ...
                            <div class="body">
                                <form action="{{ route('admin.count.store') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="icon codini yozing" name="icon" required> 
                                    </div>
                                    <div class="form-group">
                                        <h2 class="card-inside-title">Number</h2>
                                        <input type="number" class="form-control" placeholder="sonini yozing" name="number" required> 
                                    </div>
                                    <div class="form-group">
